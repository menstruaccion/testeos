...
const translations={
  es:{
    ...
    about_title:"Jóvenes construyendo una respuesta desde adentro.",
    ...
    area_management:"Desarrollo Institucional y Alianzas",
  ...
  en:{
    ...
    about_title:"Young people building a response from within.",
